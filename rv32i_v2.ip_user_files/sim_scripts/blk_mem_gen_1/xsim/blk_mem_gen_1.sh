...
#
# Script generated by Vivado on Tue Mar 31 01:12:56 +0800 2026
...
#                blk_mem_gen_1.sh [-rerun]
#                blk_mem_gen_1.sh [-reset_run]
#                blk_mem_gen_1.sh [-clean]
...
# script info
echo -e "blk_mem_gen_1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1 xil_defaultlib.blk_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
...
Usage: blk_mem_gen_1.sh [-rerun]\n\
Usage: blk_mem_gen_1.sh [-reset_run]\n\
Usage: blk_mem_gen_1.sh [-clean]\n\
