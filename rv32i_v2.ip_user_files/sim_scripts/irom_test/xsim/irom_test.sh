...
#
# Script generated by Vivado on Tue Mar 31 01:13:20 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : irom_test.sh
...
#
# Usage        : irom_test.sh
#                irom_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                irom_test.sh [-rerun]
#                irom_test.sh [-reset_run]
#                irom_test.sh [-clean]
#                irom_test.sh [-reset_log]
#                irom_test.sh [-help]
#
...
export RDI_DATADIR="E:/Xilinx/2025.2/Vivado/data"
...
# script info
echo -e "irom_test.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./irom_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot irom_test xil_defaultlib.irom_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim irom_test -key {Behavioral:sim_1:Functional:irom_test} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Xilinx/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb irom_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./irom_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: irom_test.sh [-help]\n\
Usage: irom_test.sh [-step]\n\
Usage: irom_test.sh [-lib_map_path]\n\
Usage: irom_test.sh [-rerun]\n\
Usage: irom_test.sh [-reset_run]\n\
Usage: irom_test.sh [-clean]\n\
Usage: irom_test.sh [-reset_log]\n\
Usage: irom_test.sh [-keep_index]\n\
Usage: irom_test.sh [-noclean_files]\n\n\
